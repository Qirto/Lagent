...
class AdvancedImageEnhancer:
    ...
    def process_image_array(self, image: np.ndarray) -> Optional[np.ndarray]:
        """
        Process a numpy array image directly through the enhancement pipeline.
        """
        try:
            # Step 1: Resizing
            ...
            # Step 3: Apply super-resolution effect
            ...
            self.logger.error(f"Failed to process image array: {e}")
            return None
